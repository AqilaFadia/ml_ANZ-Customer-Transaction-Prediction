...
Original file is located at
    https://colab.research.google.com/drive/1JHeiC3_Em0_YwmQBYwto6pxvqYLiMhwJ
...
# Check the size of the dataset after we drop out the outliers
anz.shape
